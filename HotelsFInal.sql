...
BEGIN
    ...
    -- Calculamos la fecha de una semana después del alquiler
    SET rental_week = DATE_ADD(NEW.rental_date, INTERVAL 1 WEEK);

    -- Verificamos si ha pasado más de una semana desde el alquiler
    IF NEW.return_date > rental_week THEN
        -- Añadimos un aviso al cliente
